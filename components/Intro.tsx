    ...
    return (
        <>
            <header className="pt-10">
                <nav className="mx-auto w-max flex flex-col gap-6">
                    <div className="relative w-max mx-auto">
                        <div className="w-[104px] h-[104px] border border-[#2b1105] rounded-full"></div>
            ...
            <div className="pt-11">
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col gap-4">
                        <p className="text-[#c6754d] text-2xl text-center">Please join us to celebrate</p>
                        <div className="flex flex-col sm:flex-row justify-center sm:gap-8 items-center">
                    ...
                    <Image src={IntroImg} alt="" className="block h-[400px] w-full mx-auto object-cover" />
                </div>
            </div>
        </>
    )
